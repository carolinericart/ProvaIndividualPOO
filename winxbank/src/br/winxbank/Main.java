...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException, IOException, ClassNotFoundException {
        ...
        RegistroDeClientes.getInstancia().printarListaDeClientes();
            while (decisao == 1 || decisao==20 || decisao == 2 || decisao == 3 || decisao == 4 || decisao == 5 || decisao == 6 || decisao == 7 || decisao == 8 || decisao == 9 || decisao == 10 || decisao == 11 || decisao == 12 || decisao == 13 || decisao == 14 || decisao == 15 || decisao == 16 || decisao == 17 || decisao == 18 || decisao == 19){
                ...
                try {
                    ...
                    switch (decisao){
                        ...
                        case 19: // EXIBIR DADOS DO BANCO
                            ...
                            break;
                            /** @author Carol */
                        case 20: // INSERIR E VISUALIZAR FEEDBACK DO CLIENTE
                            Scanner input = new Scanner(System.in);
                            System.out.println("Voce deseja inserir um novo feedback? Escreva 1 caso SIM  ou 2 caso NAO");
                            int x=input.nextInt();
                            if (x==1) {
                                System.out.println("Digite a conta a qual deseja realizar o Feedback: ");
                                int z = input.nextInt();
                                Conta conta= clienteAtual.selecionarConta(z);
                                conta.inserirFeedback();
                                conta.visualizarFeedback();
                                ArquivoFeedback.getInstancia().gerarDocFeedback(conta);
                            }
                            else if (x==2){
                                System.out.println("Caso nao deseja inserir novo Feedback, digite a conta que deseja visualizar o Feedback");
                                int z = input.nextInt();
                                Conta conta= clienteAtual.selecionarConta(z);
                                ArquivoFeedback.getInstancia().LerDocFeedback(conta);
                                        try {
                                            if (conta.getAvaliacaoOO2022().getNome()==null){
                                                throw new AvaliacaoNaoInformadaException();
                                            }
                                            conta.visualizarFeedback();
                                        }
                                        catch(AvaliacaoNaoInformadaException es){
